  ...
  return (
    <div className="about-parent">
      ...
      <div className="parents" id="about">
        <div className="content-parents border-div padding-max">
          <div className="div-left ">
            <span className="title-head-section "> 1996-1997</span>
            <h1 className="title-gradient-left titles-mobile">
              Dragon
          ...
          <div className="div-right padding-min">sadas</div>
        </div>
      </div>
      <div className="parents" id="about">
        <div className="content-parents border-div padding-max">
          ...
          <div className="div-right padding-min"><span className="title-head-section ">2015-2018</span>
            <h1 className="title-gradient-left titles-mobile">
              Dragon
